...
module.exports = (sequelize, DataTypes) => {
  ...
  User.associate = function(models) {
    ...
    User.belongsToMany (models.Follow, { as: 'followed', foreignKey: 'followingId', through:"Follow"} );
    User.belongsToMany (models.Follow, { as: 'follower', foreignKey: 'followerId', through:"Follow"} );
